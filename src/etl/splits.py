...
def get_splits(ticker):
    ...
    cols = ["ticker", "event_date", "execution_date", "split_from", "split_to"]
    return df[cols]
...
def build():
    ...
    print(f"\nSummary Splits: {created} created, {skipped} skipped, {failed} failed of {n} total tickers.")
